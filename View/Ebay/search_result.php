    ...
    <div id="um">
        <div class="yui3-g">
            <div class="yui3-u-1-8">
                <h1 id="h1al"><a id="h1a" href="/" title="nikon D7000 | Ebay Product Search | camelcamelcamel.com">nikon D7000 | Ebay Product Search | camelcamelcamel.com</a></h1>
            </div>
            ...
            <div class="yui3-u" style="width: 460px;">
                <div id="search">
                    <form onsubmit="return(check_sq($('sq')));" action="/index.php/site/search" style="display: inline;" method='get'>
                        <input name="s2" id="s2" type="hidden" value="ebay" />
...
<style>
    ...
    {
        /*
        background: transparent url(http://s3.camelcamelcamel.com/images/ebay-miniheadersprite.png) no-repeat 0% 0%;
...
<div id="breadcrumbs" class="smalltext grey">
    ...
    <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
        <a class="grey" href="http://camelcamelcamel.com/products" itemprop="url"><span itemprop="title">Ebay Products</span></a>
        &raquo;
    </div>

</div>
<div id="pagetitle" itemscope itemtype="http://data-vocabulary.org/Breadcrumb" style="margin-bottom: 10px;">
    <a href="/index.php/site/search?s=ebay&sq=<?=$data['keyword']?>" itemprop="url">
...
<div id="products_header">
    <p>Find products to track by keyword, manufacturer, or Ebay URL.


        <strong>This page searches Ebay directly.  To search our local database, <a href="/index.php/ebay/home/searchlocal?id=<?=$data['keyword'] ?>">go here</a>.</strong>
...
<tr>
    <td class="product_image">
        ...
        <a href="<? echo BASE_URL . DS . 'index.php/product/view?active=ebay&id='. $item->ASIN; ?>">
    ...
    <td class="product_info">
        ...
        <div class="product_title">
            ...
            <a title="<?=$item->name?>" href="<? echo BASE_URL . DS . 'index.php/product/view?active=ebay&id='. $item->ASIN; ?>"><?=$item->name?></a>
            ...
            <div>
                ...
                <div>
                    ...
                    <div class="order_button">
                        <a href="<? echo $item->detailURL; ?>" target="_blank" title="Click here to view this product at Ebay" onclick="camel_event('Retailer Product', 'US - Search', 'B0042X9LC4', 89695); return(true);"><img alt="view this item on at Ebay" src="http://d1i0o2gnhzh6dj.cloudfront.net/images/button-amazon-large.png"></a>
                    </div>
    ...
    <td class="price_type">
        ...
        <?  if (isset($item->price['ebay'])) { ?>
            <div class="price0">
                <a title="View the Ebay price product page for <?= $item->name?>" href="<? echo BASE_URL . DS . 'index.php/product/view?active=ebay&id='. $item->ASIN; ?>">Ebay</a>
            </div>
        <? } ?>
    ...
    <td class="current_price last">
        ...
        <?  if (isset($item->price['ebay'])) { ?>
            <div class="price_amazon">
                ...
                <span class="green"><?=$item->price['ebay']->formattedPrice; ?>
                </span>
