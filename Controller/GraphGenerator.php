...
class Controller_GraphGenerator {
    public static function generate($product){
        require SERVER_ROOT . DS . 'Lib/GoogleChart/GoogleChart.php';
        require SERVER_ROOT . DS . 'Lib/GoogleChart/markers/GoogleChartTextMarker.php';
        require SERVER_ROOT . DS . 'Lib/GoogleChart/markers/GoogleChartShapeMarker.php';
