...
require '../lib/AmazonECS.php';

try
{
    $amazonEcs = new AmazonECS(AWS_API_KEY, AWS_API_SECRET_KEY, 'FR', AWS_ASSOCIATE_TAG);
    ...
    $response = $amazonEcs->responseGroup('Large')->lookup('B00438QJ3M');
    var_dump($response->Items->Item->OfferSummary->LowestNewPrice->Amount);
    echo $response->Items->Item->OfferSummary->LowestNewPrice->Amount;
